...
- 太普通：让多吃鸭成为动作主体，加入吃/消化/吞吐的奇怪隐喻。
- 太复杂：删节点，只保留一个动作和 3-5 个短标注。
- 太可爱：强调 deadpan、blank serious expression、not cute、not mascot、not rubber-duck sticker、not children's cartoon duck。
- 太 PPT：去掉标题、边框、整齐网格和过多箭头，改成手绘场景。
- 太像旧案例：保留核心意思，换掉主物件和多吃鸭动作。
